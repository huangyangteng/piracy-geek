;(function(global) {
    ...
    TextHighlighter.prototype.getHighlights = function(params) {
        ...
        if (
            params.andSelf === true &&
            params.container.hasAttribute(DATA_ATTR)
        ) {
    ...
    TextHighlighter.prototype.isHighlight = function(el) {
        return (
            el &&
            el.nodeType === NODE_TYPE.ELEMENT_NODE &&
            el.hasAttribute(DATA_ATTR)
        )
    }
        ...
        hlDescriptors.forEach(function(hlDescriptor) {
            try {
                ...
                if (console && console.warn) {
                    console.warn(
                        "Can't deserialize highlight descriptor. Cause: " + e
                    )
                }
            }
        })
    ...
    TextHighlighter.prototype.find = function(text, caseSensitive) {
        var wnd = dom(this.el).getWindow(),
            ...
            scrollY = wnd.scrollY,
            caseSens =
                typeof caseSensitive === 'undefined' ? true : caseSensitive
